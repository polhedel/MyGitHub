...
var JiraApi = function () {
  ...
  (0, _createClass3.default)(JiraApi, [{
    ...
    key: 'makeLoginRequestHeader',
    value: function makeLoginRequestHeader(uri){
      var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
    ...
    key: 'makeLoginUri',
    value: function makeLoginUri(_ref) {
      var pathname = _ref.pathname;
      var query = _ref.query;
      ...
      var uri = _url2.default.format({
        ...
        hostname: this.host,
        port: this.port,
        pathname: this.base + '/rest/auth/1' + pathname,
        query: query
      });
      return decodeURIComponent(uri);
    }
    ...
    value: function login(){
      return this.doRequest(this.makeLoginRequestHeader(this.makeLoginUri({
        pathname: '/session'
      })))
    }
